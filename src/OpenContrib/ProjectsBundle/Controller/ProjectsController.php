...
namespace OpenContrib\ProjectsBundle\Controller;
...
class ProjectsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('OpenContribProjectsBundle::index.html.twig', array(
            'projects' => $projects,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('OpenContrib\ProjectsBundle\Form\ProjectsType', $project);
        ...
        return $this->render('OpenContribProjectsBundle::new.html.twig', array(
            'project' => $project,
    ...
    public function showAction(Projects $project)
    {
        ...
        return $this->render('OpenContribProjectsBundle::show.html.twig', array(
            'project' => $project,
    ...
    {
        $deleteForm = $this->createDeleteForm($project);
        $editForm = $this->createForm('OpenContrib\ProjectsBundle\Form\ProjectsType', $project);
        ...
        return $this->render('OpenContribProjectsBundle::edit.html.twig', array(
            'project' => $project,
